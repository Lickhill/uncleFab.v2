  ...
  return (
    <div className='flex flex-row sm:flex-roe gap-1 sm:gap-10 pt-10 border-t'>
        ...
        <div className='min-w-60'>
          ...
          {/*Category Filter */}
          <div className={`border border-gray-300 pl-5 py-3 mt-6 w-64 sm:w-52 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className={`border border-gray-300 pl-5 py-3 mt-6 w-64 sm:w-52 ${showFilter ? '' : 'hidden'} sm:block`}>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
              ...
              <p className='flex gap-2'>
                <input className='w-3' type='checkbox' value={'Tops & Bottoms'} onChange={toggleSubCategory}/> Tops & Bottoms
              </p>
              <p className='flex gap-2'>
                <input className='w-3' type='checkbox' value={'Formal'} onChange={toggleSubCategory}/> Formal
              </p>
              <p className='flex gap-2'>
                <input className='w-3' type='checkbox' value={'Ethnic Wear'} onChange={toggleSubCategory}/> Ethnic Wear
              </p>
            </div>
          </div>
        </div>
